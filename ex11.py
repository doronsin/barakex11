...
def dict_to_list(dict_leafs):
    """
    This is a 'util' function of all_illnesses function. It receives a dictionary of illnesses and their occurrences,
    (dict_leaf) and turn them to a list of tuples, sort them according to the number of occurrences and creates a sorted
    list of illnesses
    :return: A sorted list of illnesses, from the most common to the most rare.
    """
    tuple_list = list(dict_leafs.items())  # turns the dic. into a list of tuples
...
class Diagnoser:
    ...
    def diagnose_helper(self, root, symptoms):
        ...
        if root.is_leaf():  # if this is a 'leaf' return its data. i.e. illness
            return root.data
    ...
    def all_illnesses(self):
        ...
        dict_leafs = dict_leaf(list_leaf)
        return dict_to_list(dict_leafs)
...
if __name__ == "__main__":
    ...
    root1 = Node("cough", left_vertex, right_vertex)

    diagnoser = Diagnoser(root1)
